...
public class Board extends JPanel implements ActionListener {
    ...
    public Board(Main app, Tetris parent) {
    	myApp = app;
    ...
    public void start()
    {
        ...
        newPiece();
        timer.start();
        statusbar.setText("Game đã bắt đầu!");
    }
    ...
    public void pause()
    {
        ...
        if (isPaused) {
            timer.stop();
            statusbar.setText("Tạm dừng! - Nhấn P để tiếp tục.");
        } else {
            timer.start();
    ...
    {
    	statusbar.setText("Hãy tạo thành 1 hàng ngang...");
        int numFullLines = 0;
    ...
    {
    	propSpeed = speed;
    	statusbar.setText("Mời nhấn BẮT ĐẦU!");
    	timer.stop();
